...
class descargarrptDetalleAlertasChccExport implements FromView, WithDrawings,  WithEvents
{   
    // recibe parametros para realizar la consulta que pobla el reporte
    public function __construct($parametro, $comunas) {
    ...
    public function view(): View
    {
       ...
       $registros = AlertaChileCreceContigo::rptDetalleAlertasChcc(null, $this->comunas);

        return view('reportes.exports.excel_detalle_alertas_chcc', 
            [
