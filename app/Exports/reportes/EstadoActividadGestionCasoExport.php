...
class EstadoActividadGestionCasoExport implements FromView, WithDrawings,  WithEvents
{
    ...
    public function view(): View
    {
        ...
        $registrosCasos = Caso::rptEstadoActividad($this->comunas, $this->fec_ini, $this->fec_fin);

        return view('reportes.exports.excel_estado_actividad_gestion_caso', 
            [
                'registrosCasos' => $registrosCasos,
            ]
        );
