...
class GestionCasoTerapiaExport implements FromView, WithDrawings,  WithEvents
{
    ...
    public function registerEvents(): array { 
        return [AfterSheet::class => function (AfterSheet $event) {
            ...
            $event->sheet->getDelegate()->getStyle('A9:F9')->applyFromArray($estilos_titulos_tabla_contenido);
    ...
    {
        //dd($this->comunas);
        $registros = Caso::rptCasosGestionCasosTerapia($this->comunas, $this->fec_ini, $this->fec_fin);

        return view('reportes.exports.excel_gestion_caso_gestion_terapia', 
            [
                'registros' => $registros
            ]
        );
