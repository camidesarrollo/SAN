...
class descargarPlanComunalDocumentos implements FromCollection, WithDrawings,  WithEvents, WithCustomStartCell, WithHeadings {
    ...
    public function registerEvents(): array { 
        return [AfterSheet::class => function (AfterSheet $event) {
            ...
            $nombre_reporte = "";
            $info_reporte = DB::SELECT("SELECT * FROM ai_funcion WHERE cod_accion = 'ac46'");
