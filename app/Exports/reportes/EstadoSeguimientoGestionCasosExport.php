...
class EstadoSeguimientoGestionCasosExport implements FromView, WithDrawings,  WithEvents
{
    ...
    public function view(): View
    {
       ...
       $registros = Caso::rptEstadoSeguimientoCaso($this->comunas, $this->fec_ini, $this->fec_fin);

        return view('reportes.exports.excel_estado_seguimiento_gestion_casos', 
            [
                'registros' => $registros
            ]
        );
