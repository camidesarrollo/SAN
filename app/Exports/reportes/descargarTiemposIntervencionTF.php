...
class descargarTiemposIntervencionTF implements FromCollection, WithDrawings,  WithEvents, WithCustomStartCell, WithHeadings {
...
//
    public function registerEvents(): array { 
        return [AfterSheet::class => function (AfterSheet $event) {
            ...
            $event->sheet->getDelegate()->getStyle('A8:L8')->applyFromArray($estilos_titulos_tabla_contenido);


            $nombre_reporte = "";
            $info_reporte = DB::SELECT("SELECT * FROM ai_funcion WHERE cod_accion = 'ac49'");
    ...
    public function collection() {
        return collect(Helper::getTiemposIntervencionTF($this->filtro_comunas, $this->inicio, $this->fin, $this->caso, $this->gestor));
    }
    ...
    public function headings(): array {
        return [
                    ...
                    'Ejecución',
                    'Seguimiento',
                    'Cantidad de meses de intervención',
