...
if (window.require) {
  ...
  require.config({
    paths: {
      "highlight": "/mapa-familia/assets/js/highlight",
      "jquery": "/mapa-familia/assets/js/jquery.min", // 1.11.3
      "bootstrap": "/mapa-familia/assets/js/bootstrap.min"
    },
    shim: {
      "bootstrap": ["jquery"]
    }
  ...
  function goLoadSrc(filenames) {
    ...
    for (var i = 0; i < arguments.length; i++) {
      ...
      selt.async = false;
      selt.defer = false;
      selt.src = "/mapa-familia/assets/js/" + filename;
...
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/mapa-familia/assets/css/bootstrap.min.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/mapa-familia/assets/css/highlight.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/mapa-familia/assets/css/main.css";
head.appendChild(link);
