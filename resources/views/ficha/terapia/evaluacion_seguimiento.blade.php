<div class="container">
	 <div class="row">
		<div class="col-md-12 col-lg-6 text-center">
			...
			<a href="{{ route('gestion-terapia-familiar.evaluacion',[ 'tera_id' => $nna_teparia->tera_id, 'run_sin_formato' => $run, 'run_con_formato' => $run_terapia_formateado]) }}" 
		...
		<div class="col-md-12 col-lg-6 text-center">
			<br>
			@if($evaluacion_seguimiento_realizada == 1)
				<a class="btn" style="background: #01e0bc; color: #fff;">Realizado</a>
			@elseif ($evaluacion_seguimiento_realizada == 0)
