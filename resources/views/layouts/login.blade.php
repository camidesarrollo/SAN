			    ...
			    <div class="row">
						...
						<div class="col-12 col-md-4 p-3 text-center">
							<div class="card p-3">
								...
								<p class="text-dark">Ingrese al {{ env('APP_NAME') }}</p>
								<hr class="half-rule">
								<a href="{{ env('SSO_URL') . "?AID=" . env('SSO_AID') }}" class="btn btn-primary btn-lg"><span class="oi oi-account-login"></span> Acceder</a> 
