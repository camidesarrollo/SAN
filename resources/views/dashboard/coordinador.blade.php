...
<!-- 
			...
			<div class="row accesos justify-content-center"> -->
				...
				<div class="col-lg-3">
					<a href="{{ route('casos.asignarNNA') }}">
						<div class="shadow-sm p-3 btn-outline-secondary border-primary btn btn-block"> 
							<h3><span class="fa fa-user-plus"></span></h3>
							<h5>Asignar a Gestor</h5>
							<small>Asignar Caso a Gestor</small>
						</div>
					</a>
				</div>

				<div class="col-lg-3">
					<a href="{{ route('terapia.asignar_terapeuta') }}">
						<div class="shadow-sm p-3 btn-outline-secondary border-info btn btn-block"> 
							<h3><span class="fa fa-user-plus"></span></h3>
							<h5>Asignar a Terapeuta</h5>
							<small>Asignar Caso a terapeuta</small>
						</div>
					</a>
				</div>
					...
					<div class="row">
						<div class="col-6 p-3">
							<div class="card p-3 text-center ">
								...
								<a href="{{ route('casos.oficinaLocal') }}"><h4>Oficina Local NNA</h4></a>
								<p>Revisa el listado de NNA y sus asignaciones</p>
							</div>
						</div>
						...
						<div class="col-6 p-3">
							<div class="card p-3 text-center  ">
								...
								<a href="{{ route('alertas.listar') }}"><h4>Alerta Territorial</h4></a>
								<p>Puedes ingresar una Alerta Territorial para que sea atendido</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-6 p-3">
							<div class="card p-3 text-center ">
								...
								<a href="{{route('casos.asignarNNA')}}"><h4>Asignar NNA a Gestores</h4></a>
								<p>Revisa el listado de NNA para asignar a Gestores</p>
							</div>
						</div>
