    ...
    <section class=" p-3">
        <div class="container-fluid">
            ...
            <div class="row accesos justify-content-center">
                ...
                <div class="col-lg-3">
                    <a href="{{ route('alertas.listar') }}">
                        <div class="shadow-sm p-3 btn-outline-secondary border-primary btn btn-block"> 
                            ...
                            <small>Alertas creadas por Gestor</small>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3">
                    <a href="{{ route('listar.casos.desestimados') }}">
                        <div class="shadow-sm p-3 btn-outline-secondary border-primary btn btn-block"> 
                            <h3><span class="fa fa-archive"></span></h3>
                            <h5> Casos Desestimados </h5>
                            <small>Casos desestimados por Gestor</small>
                        </div>
                    </a>
                </div>
